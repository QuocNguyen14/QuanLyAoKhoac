<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucSanPhamCT.ascx.cs" Inherits="QuanLyAoKhoac.UserUL.DanhMucSanPhamCT" %>
<!--content-->
    <main class="content">
        <div class="xuhuong" style="margin-bottom:30px;"><h1><asp:Label ID="lblTenDanhMuc" runat="server"></asp:Label></h1></div>
